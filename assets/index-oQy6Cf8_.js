 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Op;function $v(){return Op||(Op=1,function(i){function e(Y,le){var ee=Y.length;Y.push(le);e:for(;0<ee;){var D=ee-1>>>1,j=Y[D];if(0<a(j,le))Y[D]=le,Y[ee]=j,ee=D;else break e}}function n(Y){return Y.length===0?null:Y[0]}function s(Y){if(Y.length===0)return null;var le=Y[0],ee=Y.pop();if(ee!==le){Y[0]=ee;e:for(var D=0,j=Y.length,ae=j>>>1;D<ae;){var Ee=2*(D+1)-1,we=Y[Ee],Re=Ee+1,De=Y[Re];if(0>a(we,ee))Re<j&&0>a(De,we)?(Y[D]=De,Y[Re]=ee,D=Re):(Y[D]=we,Y[Ee]=ee,D=Ee);else if(Re<j&&0>a(De,ee))Y[D]=De,Y[Re]=ee,D=Re;else break e}}return le}function a(Y,le){var ee=Y.sortIndex-le.sortIndex;return ee!==0?ee:Y.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var c=performance;i.unstable_now=function(){return c.now()}}else{var d=Date,g=d.now();i.unstable_now=function(){return d.now()-g}}var y=[],E=[],R=1,x=null,b=3,K=!1,X=!1,J=!1,H=typeof setTimeout=="function"?setTimeout:null,de=typeof clearTimeout=="function"?clearTimeout:null,ge=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function me(Y){for(var le=n(E);le!==null;){if(le.callback===null)s(E);else if(le.startTime<=Y)s(E),le.sortIndex=le.expirationTime,e(y,le);else break;le=n(E)}}function _e(Y){if(J=!1,me(Y),!X)if(n(y)!==null)X=!0,kt(Fe);else{var le=n(E);le!==null&&Le(_e,le.startTime-Y)}}function Fe(Y,le){X=!1,J&&(J=!1,de(T),T=-1),K=!0;var ee=b;try{for(me(le),x=n(y);x!==null&&(!(x.expirationTime>le)||Y&&!N());){var D=x.callback;if(typeof D=="function"){x.callback=null,b=x.priorityLevel;var j=D(x.expirationTime<=le);le=i.unstable_now(),typeof j=="function"?x.callback=j:x===n(y)&&s(y),me(le)}else s(y);x=n(y)}if(x!==null)var ae=!0;else{var Ee=n(E);Ee!==null&&Le(_e,Ee.startTime-le),ae=!1}return ae}finally{x=null,b=ee,K=!1}}var ye=!1,P=null,T=-1,S=5,k=-1;function N(){return!(i.unstable_now()-k<S)}function O(){if(P!==null){var Y=i.unstable_now();k=Y;var le=!0;try{le=P(!0,Y)}finally{le?I():(ye=!1,P=null)}}else ye=!1}var I;if(typeof ge=="function")I=function(){ge(O)};else if(typeof MessageChannel<"u"){var Ze=new MessageChannel,Rt=Ze.port2;Ze.port1.onmessage=O,I=function(){Rt.postMessage(null)}}else I=function(){H(O,0)};function kt(Y){P=Y,ye||(ye=!0,I())}function Le(Y,le){T=H(function(){Y(i.unstable_now())},le)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(Y){Y.callback=null},i.unstable_continueExecution=function(){X||K||(X=!0,kt(Fe))},i.unstable_forceFrameRate=function(Y){0>Y||125<Y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<Y?Math.floor(1e3/Y):5},i.unstable_getCurrentPriorityLevel=function(){return b},i.unstable_getFirstCallbackNode=function(){return n(y)},i.unstable_next=function(Y){switch(b){case 1:case 2:case 3:var le=3;break;default:le=b}var ee=b;b=le;try{return Y()}finally{b=ee}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(Y,le){switch(Y){case 1:case 2:case 3:case 4:case 5:break;default:Y=3}var ee=b;b=Y;try{return le()}finally{b=ee}},i.unstable_scheduleCallback=function(Y,le,ee){var D=i.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?D+ee:D):ee=D,Y){case 1:var j=-1;break;case 2:j=250;break;case 5:j=1073741823;break;case 4:j=1e4;break;default:j=5e3}return j=ee+j,Y={id:R++,callback:le,priorityLevel:Y,startTime:ee,expirationTime:j,sortIndex:-1},ee>D?(Y.sortIndex=ee,e(E,Y),n(y)===null&&Y===n(E)&&(J?(de(T),T=-1):J=!0,Le(_e,ee-D))):(Y.sortIndex=j,e(y,Y),X||K||(X=!0,kt(Fe))),Y},i.unstable_shouldYield=N,i.unstable_wrapCallback=function(Y){var le=b;return function(){var ee=b;b=le;try{return Y.apply(this,arguments)}finally{b=ee}}}}(hh)),hh}var Vp;function Hv(){return Vp||(Vp=1,ch.exports=$v()),ch.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yv=He.forwardRef(({color:i="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:s,className:a="",children:c,iconNode:d,...g},y)=>He.createElement("svg",{ref:y,...Xv,width:e,height:e,stroke:i,strokeWidth:s?Number(n)*24/Number(e):n,className:Wm("lucide",a),...g},[...d.map(([E,R])=>He.createElement(E,R)),...Array.isArray(c)?c:[c]]));/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zh=(i,e)=>{const n=He.forwardRef(({className:s,...a},c)=>He.createElement(Yv,{ref:c,iconNode:e,className:Wm(`lucide-${Qv(i)}`,s),...a}));return n.displayName=`${i}`,n};/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zi=new Bh("@firebase/firestore");function zs(){return zi.logLevel}function ie(i,...e){if(zi.logLevel<=Ie.DEBUG){const n=e.map(Wh);zi.debug(`Firestore (${to}): ${i}`,...n)}}function Bi(i,...e){if(zi.logLevel<=Ie.ERROR){const n=e.map(Wh);zi.error(`Firestore (${to}): ${i}`,...n)}}function nu(i,...e){if(zi.logLevel<=Ie.WARN){const n=e.map(Wh);zi.warn(`Firestore (${to}): ${i}`,...n)}}function Wh(i){if(typeof i=="string")return i;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kn{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(a){try{return atob(a)}catch(c){throw typeof DOMException<"u"&&c instanceof DOMException?new J0("Invalid base64 string: "+c):c}}(e);return new Kn(n)}static fromUint8Array(e){const n=function(a){let c="";for(let d=0;d<a.length;++d)c+=String.fromCharCode(a[d]);return c}(e);return new Kn(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const s=new Uint8Array(n.length);for(let a=0;a<n.length;a++)s[a]=n.charCodeAt(a);return s}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Ve(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Kn.EMPTY_BYTE_STRING=new Kn("");const Z0=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function $i(i){if(Je(!!i),typeof i=="string"){let e=0;const n=Z0.exec(i);if(Je(!!n),n[1]){let a=n[1];a=(a+"000000000").substr(0,9),e=Number(a)}const s=new Date(i);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:It(i.seconds),nanos:It(i.nanos)}}function It(i){return typeof i=="number"?i:typeof i=="string"?Number(i):0}function Xs(i){return typeof i=="string"?Kn.fromBase64String(i):Kn.fromUint8Array(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pu=new Bh("@firebase/auth");function pT(i,...e){pu.logLevel<=Ie.WARN&&pu.warn(`Auth (${eo}): ${i}`,...e)}function Ql(i,...e){pu.logLevel<=Ie.ERROR&&pu.error(`Auth (${eo}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QT(i,e,n=!1){const{auth:s}=i;if(pr(s.app))return Promise.reject(ni(s));const a="reauthenticate";try{const c=await fa(i,Ry(s,a,e,i),n);pe(c.idToken,s,"internal-error");const d=yd(c.idToken);pe(d,s,"internal-error");const{sub:g}=d;return pe(i.uid===g,s,"user-mismatch"),oi._forOperation(i,a,c)}catch(c){throw(c==null?void 0:c.code)==="auth/user-not-found"&&_r(s,"user-mismatch"),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function p1(i,e){return e?yr(e):(pe(i._popupRedirectResolver,i,"argument-error"),i._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wd extends Sy{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Gs(e,this._buildIdpRequest())}_linkToIdToken(e,n){return Gs(e,this._buildIdpRequest(n))}_getReauthenticationResolver(e){return Gs(e,this._buildIdpRequest())}_buildIdpRequest(e){const n={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(n.idToken=e),n}}function m1(i){return XT(i.auth,new wd(i),i.bypassAuthState)}function g1(i){const{auth:e,user:n}=i;return pe(n,e,"internal-error"),QT(n,new wd(i),i.bypassAuthState)}async function y1(i){const{auth:e,user:n}=i;return pe(n,e,"internal-error"),KT(n,new wd(i),i.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y1="__/auth/handler",J1="emulator/auth/handler",Z1=encodeURIComponent("fac");async function bm(i,e,n,s,a,c){pe(i.config.authDomain,i,"auth-domain-config-required"),pe(i.config.apiKey,i,"invalid-api-key");const d={apiKey:i.config.apiKey,appName:i.name,authType:n,redirectUrl:s,v:eo,eventId:a};if(e instanceof Ay){e.setDefaultLanguage(i.languageCode),d.providerId=e.providerId||"",I_(e.getCustomParameters())||(d.customParameters=JSON.stringify(e.getCustomParameters()));for(const[R,x]of Object.entries({}))d[R]=x}if(e instanceof wa){const R=e.getScopes().filter(x=>x!=="");R.length>0&&(d.scopes=R.join(","))}i.tenantId&&(d.tid=i.tenantId);const g=d;for(const R of Object.keys(g))g[R]===void 0&&delete g[R];const y=await i._getAppCheckToken(),E=y?`#${Z1}=${encodeURIComponent(y)}`:"";return`${eI(i)}?${ma(g).slice(1)}${E}`}function eI({config:i}){return i.emulator?gd(i,J1):`https://${i.authDomain}/${Y1}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wh="webStorageSupport";class tI{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ny,this._completeRedirectFn=A1,this._overrideRedirectResult=T1}async _openPopup(e,n,s,a){var c;Er((c=this.eventManagers[e._key()])===null||c===void 0?void 0:c.manager,"_initialize() not called before _openPopup()");const d=await bm(e,n,s,Fh(),a);return Q1(e,d,Ed())}async _openRedirect(e,n,s,a){await this._originValidation(e);const c=await bm(e,n,s,Fh(),a);return i1(c),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:a,promise:c}=this.eventManagers[n];return a?Promise.resolve(a):(Er(c,"If manager is not set, promise should be"),c)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await $1(e),s=new k1(e);return n.register("authEvent",a=>(pe(a==null?void 0:a.authEvent,e,"invalid-auth-event"),{status:s.onEvent(a.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(wh,{type:wh},a=>{var c;const d=(c=a==null?void 0:a[0])===null||c===void 0?void 0:c[wh];d!==void 0&&n(!!d),_r(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=x1(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return wy()||my()||vd()}}const nI=tI;var jm="@firebase/auth",zm="1.8.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const oI=5*60,aI=Ym("authIdTokenMaxAge")||oI;let Bm=null;const lI=i=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>aI)return;const a=n==null?void 0:n.token;Bm!==a&&(Bm=a,await fetch(i,{method:a?"POST":"DELETE",headers:a?{Authorization:`Bearer ${a}`}:{}}))};function uI(i=tg()){const e=Hh(i,"auth");if(e.isInitialized())return e.getImmediate();const n=jT(i,{popupRedirectResolver:nI,persistence:[f1,t1,Ny]}),s=Ym("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const c=new URL(s,location.origin);if(location.origin===c.origin){const d=lI(c.toString());JT(n,d,()=>d(n.currentUser)),YT(n,g=>d(g))}}const a=Qm("auth");return a&&BT(n,`http://${a}`),n}function cI(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}MT({loadJS(i){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=a=>{const c=qn("internal-error");c.customData=a,n(c)},s.type="text/javascript",s.charset="UTF-8",cI().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});sI("Browser");const hI=()=>{const i=He.useRef(null),e=He.useRef(null),n=He.useRef(null),[s,a]=He.useState({x:0,y:0});return He.useEffect(()=>{const c=d=>{if(!i.current)return;const g=i.current.getBoundingClientRect(),y=g.left+g.width/2,E=g.top+g.height/2;a({x:d.clientX-y,y:d.clientY-E})};return window.addEventListener("mousemove",c),()=>window.removeEventListener("mousemove",c)},[]),He.useEffect(()=>{if(!e.current||!n.current)return;const c=10,d=Math.atan2(s.y,s.x),g=Math.min(Math.hypot(s.x,s.y)/100,1),y=Math.cos(d)*c*g,E=Math.sin(d)*c*g;e.current.style.transform=`translate(${y}px, ${E}px)`,n.current.style.transform=`translate(${y}px, ${E}px)`},[s]),oe.jsx("div",{className:"w-64 h-64 md:w-96 md:h-96",children:oe.jsxs("svg",{ref:i,viewBox:"0 0 400 400",className:"w-full h-full",children:[oe.jsx("defs",{children:oe.jsxs("linearGradient",{id:"faceGradient",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[oe.jsx("stop",{offset:"0%",stopColor:"#FFE0B2"}),oe.jsx("stop",{offset:"100%",stopColor:"#FFCC80"})]})}),oe.jsx("path",{d:`M200 350 
             ...
             C 180 300, 220 300, 240 280`,fill:"none",stroke:"#000000",strokeWidth:"2",strokeLinecap:"round"})]})})},dI="https://us-central1-my-portfolio-4ace3.cloudfunctions.net/chat",js=50,$m=({text:i,isUser:e,isLoading:n})=>{const[s,a]=He.useState(!e);return oe.jsx("div",{className:`flex ${e?"justify-end":"justify-start"} mb-4`,children:oe.jsx("div",{className:`rounded-2xl px-4 py-2 max-w-[80%] ${e?"bg-blue-500 text-white":"bg-gray-100"}`,children:n?oe.jsxs("div",{className:"flex space-x-2 justify-center",children:[oe.jsx("div",{className:"w-2 h-2 bg-gray-500 rounded-full animate-bounce"}),oe.jsx("div",{className:"w-2 h-2 bg-gray-500 rounded-full animate-bounce",style:{animationDelay:"0.2s"}}),oe.jsx("div",{className:"w-2 h-2 bg-gray-500 rounded-full animate-bounce",style:{animationDelay:"0.4s"}})]}):oe.jsx("p",{className:"text-sm md:text-base",children:e?i:s?oe.jsx(fI,{text:i,onComplete:()=>a(!1)}):i})})})},fI=({text:i,onComplete:e})=>{const[n,s]=He.useState(""),[a,c]=He.useState(0);return He.useEffect(()=>{if(a<i.length){const d=setTimeout(()=>{s(g=>g+i[a]),c(a+1)},20);return()=>clearTimeout(d)}else e&&e()},[a,i,e]),oe.jsx("span",{children:n})},pI=({text:i,onClick:e,disabled:n})=>oe.jsxs("button",{onClick:e,disabled:n,className:`px-4 py-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors 
                text-sm whitespace-nowrap flex items-center gap-2 
                ${n?"opacity-50 cursor-not-allowed":""}`,children:[i,oe.jsx(Jv,{size:16})]}),mI=()=>oe.jsx("div",{className:"bg-gradient-to-r from-yellow-100 to-yellow-50 border-b border-yellow-200 p-6 mb-8 rounded-lg shadow-sm",children:oe.jsxs("div",{className:"max-w-4xl mx-auto",children:[oe.jsxs("div",{className:"flex items-center justify-center gap-3 mb-3",children:[oe.jsx(Zv,{className:"text-yellow-600",size:24}),oe.jsx("h1",{className:"text-2xl font-semibold text-yellow-800",children:"Website Under Construction"})]}),oe.jsx("p",{className:"text-center text-yellow-700",children:"Expected completion: February 5th, 2025"}),oe.jsx("p",{className:"text-center text-yellow-600 mt-2",children:"In the meantime, feel free to chat with my AI assistant below - they have all the information you need about my experience, projects, and skills!"})]})}),gI=()=>{const[i,e]=He.useState([{text:"👋 Hello! I'm Michael's AI assistant. I can tell you all about his experience at Meta, his work in full-stack development, and his projects. What would you like to know?",isUser:!1,timestamp:new Date().toISOString()}]),[n,s]=He.useState(""),[a,c]=He.useState(!1),[d,g]=He.useState(null),[y,E]=He.useState(0),[R,x]=He.useState(null),b=He.useRef(null),K=["Tell me about your experience","Show me your favorite project","What are your skills?","How can I contact you?"];He.useEffect(()=>{(async()=>{try{const de=await GT(wI);x(de.user.uid)}catch(de){console.error("Error initializing auth:",de)}})()},[]);const X=()=>{var H;(H=b.current)==null||H.scrollIntoView({behavior:"smooth"})};He.useEffect(X,[i]);const J=async H=>{if(!H.trim()||a||!R)return;const de={text:H,isUser:!0,timestamp:new Date().toISOString()};e(ge=>[...ge,de]),s(""),c(!0);try{const ge=i.concat(de).map(ye=>({role:ye.isUser?"user":"assistant",content:ye.text})),me=await fetch(dI,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:ge})});if(!me.ok)throw new Error(`HTTP error! status: ${me.status}`);const Fe={text:(await me.json()).message,isUser:!1,timestamp:new Date().toISOString()};if(c(!1),e(ye=>[...ye,Fe]),d)await hT(Gg(Hm,"conversations",d),{messages:[...i,de,Fe],messageCount:y+1,lastUpdated:Am(),userId:R});else{const ye=await dT(Zw(Hm,"conversations"),{userId:R,startedAt:Am(),messages:[de,Fe],messageCount:1});g(ye.id)}}catch(ge){console.error("Error:",ge),c(!1);const me={text:"I apologize, but I'm having trouble connecting. Please try again later.",isUser:!1,timestamp:new Date().toISOString()};e(_e=>[..._e,me])}};return oe.jsx("div",{className:"min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4",children:oe.jsxs("div",{className:"max-w-4xl mx-auto",children:[oe.jsx(mI,{}),oe.jsx("div",{className:"flex justify-center mb-8",children:oe.jsx(hI,{})}),oe.jsxs("div",{className:"bg-white rounded-2xl shadow-lg p-4",children:[oe.jsxs("div",{className:"h-96 overflow-y-auto mb-4 p-4",children:[i.map((H,de)=>oe.jsx($m,{text:H.text,isUser:H.isUser},de)),a&&oe.jsx($m,{text:"",isUser:!1,isLoading:!0}),oe.jsx("div",{ref:b})]}),oe.jsx("div",{className:"flex gap-2 mb-4 overflow-x-auto pb-2",children:K.map((H,de)=>oe.jsx(pI,{text:H,onClick:()=>J(H),disabled:a||y>=js},de))}),oe.jsxs("div",{className:"flex gap-2",children:[oe.jsx("input",{type:"text",value:n,onChange:H=>s(H.target.value),onKeyPress:H=>H.key==="Enter"&&J(n),placeholder:y>=js?"Message limit reached":"Type your message...",className:"flex-1 px-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:border-blue-500",disabled:a||y>=js}),oe.jsx("button",{onClick:()=>J(n),disabled:a||!n.trim()||y>=js,className:`p-2 rounded-full bg-blue-500 text-white transition-colors ${a||!n.trim()||y>=js?"opacity-50 cursor-not-allowed":"hover:bg-blue-600"}`,children:oe.jsx(e_,{size:20})})]}),y>0&&oe.jsxs("div",{className:"text-xs text-gray-500 mt-2 text-right",children:["Messages: ",y,"/",js]})]})]})})};function yI(){return oe.jsx(gI,{})}var vI="firebase",_I="11.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
